...
def get_dataset(opts):
    ...
    if opts.dataset == 'voc':
        train_transform = train_et.ExtCompose([
            ...
            train_et.ExtRandomCrop(size=(opts.crop_size, opts.crop_size), pad_if_needed=True),
    ...
    if opts.dataset == 'cityscapes':
        train_transform = train_et.ExtCompose([
            # et.ExtResize( 512 ),
            train_et.ExtRandomCrop(size=(opts.crop_size, opts.crop_size)),
            train_et.ExtColorJitter(brightness=0.5, contrast=0.5, saturation=0.5),
